...
const idID: Messages = {
  ...
  reviews: {
    ...
    description:
      "Lihat penilaian pelanggan atas pesanan dan menu, lalu balas ulasan yang belum ditanggapi.",
    summary: {
      heading: "Ringkasan ulasan",
      average: "Rata-rata penilaian",
      count: "{count} ulasan",
      unreplied: "{count} menunggu balasan",
      allReplied: "Semua sudah dibalas",
      distribution: "Sebaran penilaian",
      starLabel: "{rating} bintang",
    },
    filters: {
      rating: "Penilaian",
      all: "Semua",
      replied: "Status balasan",
      repliedNo: "Belum dibalas",
      repliedYes: "Sudah dibalas",
      from: "Dari tanggal",
      to: "Sampai tanggal",
      reset: "Hapus filter",
    },
    card: {
      guest: "Tamu",
      order: "Pesanan {orderNumber}",
      orderUnknown: "Tanpa nomor pesanan",
      dishRatings: "Penilaian per menu",
      dishUnknown: "Menu yang sudah ditarik",
      noContent: "Pelanggan memberi nilai tanpa komentar.",
      replyHeading: "Balasan restoran",
      replyPlaceholder: "Tulis balasan untuk ulasan ini…",
      replySubmit: "Balas",
      replySending: "Mengirim…",
    },
    empty: {
      title: "Belum ada ulasan pelanggan",
      hint: "Pelanggan bisa mengulas setelah pesanan selesai, dan ulasannya muncul di sini.",
      filteredTitle: "Tidak ada ulasan yang cocok",
      filteredHint:
        "Coba longgarkan penilaian, status balasan, atau rentang tanggal.",
    },
    pagination: {
      summary: "Halaman {page} dari {totalPages} · {total} ulasan",
      prev: "Sebelumnya",
      next: "Berikutnya",
    },
    errors: {
      noRestaurant: "Pilih restoran terlebih dahulu.",
      loadFailed: "Tidak dapat memuat ulasan pelanggan. Coba lagi.",
      forbidden: "Anda tidak punya akses ke ulasan restoran ini.",
      replyFailed: "Balasan gagal dikirim. Coba lagi.",
      replyRequired: "Tulis isi balasan terlebih dahulu.",
      notFound: "Ulasan ini tidak ditemukan. Muat ulang lalu coba lagi.",
    },
    messages: {
  ...
  platformOnboarding: {
    ...
    loading: "Memuat...",
    refresh: "Muat ulang",
    empty: "Tidak ada pengajuan yang cocok.",
    rejectionReason: "Alasan penolakan: {reason}",
    badgeAriaLabel: "{count} pengajuan menunggu tinjauan",
    filter: { all: "Semua status" },
    status: {
      submitted: "Menunggu tinjauan",
      provisioning: "Penyiapan",
      completed: "Selesai",
      rejected: "Ditolak",
    },
    stats: {
    ...
    table: {
      business: "Toko",
      contact: "Kontak",
      planDomain: "Paket / domain",
      status: "Status",
      submittedAt: "Waktu pengajuan",
      actions: "Tindakan",
    },
    actions: {
    ...
    plan: { trial: "Uji coba" },
    handoff: {
      title: "{business}: detail aktivasi pemilik",
      manualNote:
        "Sistem tidak mengirim email. Serahkan nama pengguna dan tautan penyetelan kata sandi kepada pemilik; tautan berlaku 24 jam dan hangus setelah sekali pakai.",
      dismiss: "Tutup",
      delivery: "Pengiriman kredensial: {channel} · {status}",
      unavailable:
        "Tidak ada tautan penyetelan yang tersisa; pemilik mungkin sudah menyetel kata sandi. Jika tidak bisa masuk, beralihlah ke toko ini dan setel ulang kata sandinya di menu Karyawan.",
      expired:
        "Tautan penyetelan ini sudah kedaluwarsa. Buat ulang, atau beralih ke toko ini dan setel ulang kata sandi pemilik di menu Karyawan.",
      username: "Nama pengguna",
      expiresAt: "Berlaku hingga",
      setupLink: "Tautan penyetelan",
      ids: "Restoran / pengguna",
      copy: "Salin",
      copied: "Tersalin",
      regenerate: "Buat ulang tautan",
      regenerating: "Membuat ulang...",
    },
    deliveryChannel: { email: "Email", manual: "Serah terima manual" },
    deliveryStatus: {
      sent: "Terkirim",
      pending: "Menunggu",
    ...
    reject: {
      ...
      confirm: "Konfirmasi tolak",
    },
    regenerate: {
      title: "Buat ulang tautan penyetelan?",
      description:
        "Tautan lama langsung tidak berlaku. Jika sudah diserahkan, pemilik tidak dapat memakainya lagi.",
      confirm: "Buat ulang",
    },
    errors: {
      ...
      reject: "Penolakan gagal. Coba lagi.",
  ...
  owner: {
    ...
    alerts: {
      inventory_depleted: {
        title: "{name} telah habis",
        description: "{name} kini 0 {unit} dan perlu segera diisi ulang.",
      },
      inventory_low: {
        title: "{name} di bawah stok minimum",
        description:
          "{name} kini {currentStock} {unit}, di bawah stok minimum {minStockLevel} {unit}.",
      },
      order_overdue: {
        title: "Pesanan {orderNumber} terlambat",
        description:
  ...
  settings: {
    ...
    general: {
      ...
      restaurantAddressPlaceholder: "Contoh: Jl. Contoh No. 12",
      city: "Kota",
      cityPlaceholder: "Contoh: Jakarta",
      district: "Kecamatan",
      districtPlaceholder: "Contoh: Menteng",
      districtRequired: "Masukkan kecamatan yang sebenarnya.",
      onboardingPlaceholderHint:
        "Ini data sementara saat aktivasi. Ganti dengan alamat sebenarnya.",
