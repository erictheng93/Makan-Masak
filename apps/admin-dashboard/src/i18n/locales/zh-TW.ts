...
const zhTWCore = {
  ...
  platformOnboarding: {
    ...
    refresh: "重新整理",
    empty: "目前沒有符合條件的申請。",
    rejectionReason: "拒絕原因：{reason}",
    badgeAriaLabel: "{count} 筆待審核申請",
    filter: { all: "全部狀態" },
    status: {
      submitted: "待審核",
      provisioning: "建置中",
    ...
    plan: { trial: "試用" },
    handoff: {
      title: "{business}：店主開通資訊",
      manualNote:
        "系統目前不寄信。請把帳號與設定密碼連結交給店主；連結 24 小時內有效，使用一次後即失效。",
      dismiss: "關閉",
      delivery: "憑證交付：{channel} · {status}",
      unavailable:
        "查無可用的設定密碼連結，店主可能已經設定過密碼。若店主無法登入，請切換到這家店，在「員工管理」替店主重設密碼。",
      expired:
        "這條設定密碼連結已過期，店主無法再使用。可以重新產生一條，或切換到這家店在「員工管理」替店主重設密碼。",
      username: "帳號",
      expiresAt: "有效期限",
      setupLink: "設定密碼連結",
      ids: "餐廳 / 使用者",
    ...
    deliveryChannel: { email: "Email", manual: "人工轉交" },
    deliveryStatus: {
      sent: "已寄出",
      pending: "待處理",
      failed: "寄送失敗",
    ...
    regenerate: {
      title: "重新產生設定密碼連結？",
      description:
        "舊連結會立即失效。如果已經把舊連結交給店主，對方將無法再使用它。",
      confirm: "確認重新產生",
    },
    errors: {
      load: "店家加入申請暫時無法載入。",
  ...
  settings: {
    ...
    general: {
      ...
      restaurantAddressPlaceholder: "例如：中山區範例路 12 號",
      city: "城市",
      cityPlaceholder: "例如：台北市",
      district: "區域",
      districtPlaceholder: "例如：中山區",
      districtRequired: "請填寫實際行政區。",
      onboardingPlaceholderHint: "這是開通時的暫時資料，請改成實際地址。",
      businessHours: "營業時間",
      to: "至",
      timezone: "時區",
      timezones: {
