...
const zhCN: Messages = {
  ...
  reviews: {
    title: "顾客评价",
    description: "查看顾客对订单与菜品的评分，并回复尚未处理的评价。",
    summary: {
      heading: "评价总览",
      average: "平均评分",
      count: "共 {count} 条评价",
      unreplied: "{count} 条待回复",
      allReplied: "全部已回复",
      distribution: "评分分布",
      starLabel: "{rating} 星",
    },
    ...
    card: {
      guest: "访客",
      order: "订单 {orderNumber}",
      orderUnknown: "无订单编号",
      dishRatings: "菜品评分",
      dishUnknown: "已下架的菜品",
      noContent: "顾客未留下文字评价。",
      replyHeading: "商家回复",
      replyPlaceholder: "写下对这条评价的回复…",
      replySubmit: "回复",
      replySending: "发送中…",
    },
    empty: {
      title: "暂无顾客评价",
      hint: "顾客完成订单后即可留下评价，评价会显示在这里。",
      filteredTitle: "没有符合条件的评价",
      filteredHint: "试着放宽评分、回复状态或日期范围。",
    },
    pagination: {
    ...
    errors: {
      noRestaurant: "请先选择要查看的门店。",
      loadFailed: "无法加载顾客评价，请稍后再试。",
      forbidden: "没有权限查看该门店的顾客评价。",
      replyFailed: "回复失败，请稍后再试。",
      replyRequired: "请先输入回复内容。",
      notFound: "找不到这条评价，请刷新后再试。",
    },
    messages: {
      replied: "已发送回复。",
    },
  ...
  broadcasts: {
    title: "推送消息",
    description: "向关注本店、且同意接收营销通知的顾客推送一条消息。",
    compose: {
      heading: "撰写推送",
      titleLabel: "标题",
      titlePlaceholder: "例如：今晚炸鸡买一送一",
      bodyLabel: "内容",
      bodyPlaceholder: "写下想让顾客知道的事…",
      urlLabel: "链接（选填）",
      urlPlaceholder: "https://… 或 /markets/ximen",
      urlHint: "顾客点开通知后前往的页面；留空则只显示文字。",
      includeMarket: "同时通知市场关注者",
      includeMarketHint:
        "也推给关注本店所在市场、但还没关注本店的顾客（他们可自行关闭）。",
      submit: "预览并发送",
      sending: "发送中…",
    },
    quota: {
      remaining: "今日剩余 {remaining} / {limit} 条",
      exhausted: "今日额度已用完，明天才能再发送。",
    },
    confirm: {
      heading: "确认发送",
      audience: "将推送给关注本店且同意营销的顾客",
      audienceMarket: "将推送给关注本市场且同意营销的顾客",
      irreversible: "推送发出后无法撤回，也无法修改。",
      send: "确认发送",
      cancel: "返回修改",
    },
    result: {
      ...
      failed: "送达失败",
      skipped: "跳过",
      note: "触达人数算人，送达／失败／跳过算设备：同一个人有两部手机就会算两次。跳过多半是顾客设定的免打扰时段。",
    },
    history: {
      heading: "发送记录",
      empty: "还没有发送过推送。",
    ...
    errors: {
      noRestaurant: "请先选择要推送的店铺。",
      loadFailed: "无法载入发送记录，请稍后再试。",
      sendFailed: "推送发送失败，请稍后再试。",
      forbidden: "没有权限为这个对象发送推送。",
      notFound: "找不到这个推送对象，请刷新后再试。",
      rateLimited: "已达发送上限，{hours} 小时 {minutes} 分后可再发送。",
      validation: "标题、内容或链接不符合规定，请调整后再发送。",
    },
  },
  ...
  platformOnboarding: {
    ...
    plan: { trial: "试用" },
    handoff: {
      title: "{business}：店主开通资讯",
      manualNote:
        "系统目前不寄信。请把帐号与设定密码连结交给店主；连结 24 小时内有效，使用一次后即失效。",
      dismiss: "关闭",
      delivery: "凭证交付：{channel} · {status}",
      unavailable:
        "查无可用的设定密码连结，店主可能已经设定过密码。若店主无法登入，请切换到这家店，在「员工管理」替店主重设密码。",
      expired:
        "这条设定密码连结已过期，店主无法再使用。可以重新产生一条，或切换到这家店在「员工管理」替店主重设密码。",
      username: "帐号",
      expiresAt: "有效期限",
      setupLink: "设定密码连结",
      ids: "餐厅 / 使用者",
    ...
    deliveryChannel: { email: "Email", manual: "人工转交" },
    deliveryStatus: {
      sent: "已寄出",
      pending: "待处理",
      failed: "寄送失败",
    ...
    regenerate: {
      title: "重新产生设定密码连结？",
      description:
        "旧连结会立即失效。如果已经把旧连结交给店主，对方将无法再使用它。",
      confirm: "确认重新产生",
    },
    errors: {
      load: "店家加入申请暂时无法载入。",
  ...
  owner: {
    ...
    alerts: {
      inventory_depleted: {
        title: "{name} 已用尽",
        description: "{name} 当前库存为 0 {unit}，需要立即补货。",
      },
      inventory_low: {
        title: "{name} 低于安全库存",
        description:
          "{name} 当前库存 {currentStock} {unit}，低于安全库存 {minStockLevel} {unit}。",
      },
      order_overdue: {
        title: "订单 {orderNumber} 已超时",
        description:
  ...
  settings: {
    ...
    general: {
      ...
      restaurantAddressPlaceholder: "例如：示例路 12 号",
      city: "城市",
      cityPlaceholder: "例如：北京市",
      district: "区域",
      districtPlaceholder: "例如：朝阳区",
      districtRequired: "请填写实际行政区。",
      onboardingPlaceholderHint: "这是开通时的临时数据，请改成实际地址。",
      businessHours: "营业时间",
      to: "至",
      timezone: "时区",
      timezones: {
