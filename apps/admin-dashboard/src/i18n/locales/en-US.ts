...
const enUS: Messages = {
  ...
  reviews: {
    ...
    description:
      "See how diners rated their orders and dishes, and reply to the ones still waiting.",
    summary: {
      heading: "Review overview",
      average: "Average rating",
      count: "{count} reviews",
      unreplied: "{count} awaiting reply",
    ...
    card: {
      ...
      orderUnknown: "No order number",
      dishRatings: "Dish ratings",
      dishUnknown: "Removed item",
      noContent: "The diner left a rating without a comment.",
    ...
    empty: {
      ...
      hint: "Diners can review an order once it is completed, and their reviews show up here.",
      filteredTitle: "No reviews match these filters",
      filteredHint: "Try widening the rating, reply status or date range.",
    },
    pagination: {
      summary: "Page {page} of {totalPages} · {total} reviews",
      prev: "Previous",
      next: "Next",
    },
    errors: {
      noRestaurant: "Choose a restaurant first.",
      loadFailed: "Could not load customer reviews. Please try again.",
      forbidden: "You do not have access to this restaurant's reviews.",
  ...
  platformOnboarding: {
    ...
    badgeAriaLabel: "{count} applications pending review",
    ...
    plan: { trial: "Trial" },
    handoff: {
      title: "{business}: owner activation details",
      manualNote:
        "No email is sent. Hand the username and setup link to the owner; the link works for 24 hours and expires once used.",
      dismiss: "Close",
      delivery: "Credential delivery: {channel} · {status}",
      unavailable:
        "No usable setup link remains; the owner may already have set a password. If they cannot sign in, switch to this shop and reset their password under Staff.",
      expired:
        "This setup link has expired. Regenerate one, or switch to this shop and reset the owner password under Staff.",
      username: "Username",
      expiresAt: "Expires",
      ...
      copy: "Copy",
      copied: "Copied",
      regenerate: "Regenerate setup link",
      regenerating: "Regenerating...",
    },
    deliveryChannel: { email: "Email", manual: "Manual handoff" },
    deliveryStatus: {
      sent: "Sent",
      pending: "Pending",
      failed: "Failed",
    ...
    regenerate: {
      title: "Regenerate the setup link?",
      description:
        "The old link stops working immediately. If it was already handed over, the owner will not be able to use it.",
      confirm: "Regenerate",
    },
    errors: {
      ...
      copy: "Could not copy to the clipboard. Select the text and copy it manually.",
      reject: "Rejecting the application failed. Try again.",
  ...
  owner: {
    ...
    alerts: {
      inventory_depleted: {
        ...
        description: "{name} is at 0 {unit} and needs restocking.",
      },
      inventory_low: {
        title: "{name} is below its minimum",
        description:
          "{name} is at {currentStock} {unit}, below the {minStockLevel} {unit} minimum.",
      },
      order_overdue: {
        title: "Order {orderNumber} is overdue",
        description:
  ...
  settings: {
    ...
    general: {
      ...
      restaurantAddressPlaceholder: "e.g. 12 Jalan Example, Taman Example",
      city: "City",
      cityPlaceholder: "e.g. Kuala Lumpur",
      district: "District",
      districtPlaceholder: "e.g. Bukit Bintang",
      districtRequired: "Enter your actual district.",
      onboardingPlaceholderHint:
        "This is temporary setup data. Replace it with your actual address.",
  ...
  leaveActions: {
    cancelReasonPrompt: "Enter a reason for cancelling",
  },
  payment: {
    recommended: "Recommended",
