...
const viVN: Messages = {
  ...
  reviews: {
    ...
    description:
      "Xem khách chấm điểm đơn hàng và món ăn, rồi trả lời những đánh giá còn bỏ ngỏ.",
    summary: {
      heading: "Tổng quan đánh giá",
      average: "Điểm trung bình",
      count: "{count} đánh giá",
      unreplied: "{count} chờ trả lời",
      allReplied: "Đã trả lời hết",
      distribution: "Phân bố điểm",
      starLabel: "{rating} sao",
    },
    filters: {
      rating: "Điểm",
      all: "Tất cả",
      replied: "Trạng thái trả lời",
      repliedNo: "Chưa trả lời",
      repliedYes: "Đã trả lời",
      from: "Từ ngày",
      to: "Đến ngày",
      reset: "Xóa bộ lọc",
    },
    card: {
      ...
      order: "Đơn {orderNumber}",
      orderUnknown: "Không có mã đơn",
      dishRatings: "Điểm từng món",
      dishUnknown: "Món đã ngừng bán",
      noContent: "Khách chấm điểm nhưng không để lại nhận xét.",
      replyHeading: "Phản hồi của quán",
      replyPlaceholder: "Viết phản hồi cho đánh giá này…",
      replySubmit: "Trả lời",
      replySending: "Đang gửi…",
    },
    empty: {
      title: "Chưa có đánh giá nào",
      hint: "Khách có thể đánh giá sau khi đơn hoàn tất, và đánh giá sẽ hiện ở đây.",
      filteredTitle: "Không có đánh giá nào khớp bộ lọc",
      filteredHint: "Thử nới rộng điểm, trạng thái trả lời hoặc khoảng ngày.",
    },
    pagination: {
      summary: "Trang {page}/{totalPages} · {total} đánh giá",
      prev: "Trước",
      next: "Sau",
    },
    errors: {
      noRestaurant: "Hãy chọn nhà hàng trước.",
      loadFailed: "Không tải được đánh giá của khách. Vui lòng thử lại.",
      forbidden: "Bạn không có quyền xem đánh giá của nhà hàng này.",
      replyFailed: "Không gửi được phản hồi. Vui lòng thử lại.",
      replyRequired: "Hãy nhập nội dung phản hồi.",
      notFound: "Không tìm thấy đánh giá này. Hãy tải lại trang.",
    },
    messages: {
  ...
  platformOnboarding: {
    ...
    badgeAriaLabel: "{count} đơn chờ duyệt",
    filter: { all: "Tất cả trạng thái" },
    status: {
      submitted: "Chờ duyệt",
    ...
    plan: { trial: "Dùng thử" },
    handoff: {
      title: "{business}: thông tin kích hoạt chủ cửa hàng",
      manualNote:
        "Hệ thống không gửi email. Hãy chuyển tài khoản và liên kết đặt mật khẩu cho chủ cửa hàng; liên kết có hiệu lực 24 giờ và hết hạn sau một lần dùng.",
      dismiss: "Đóng",
      delivery: "Gửi thông tin đăng nhập: {channel} · {status}",
      unavailable:
        "Không còn liên kết đặt mật khẩu khả dụng; chủ cửa hàng có thể đã đặt mật khẩu. Nếu họ không đăng nhập được, hãy chuyển sang cửa hàng này và đặt lại mật khẩu trong phần Nhân viên.",
      expired:
        "Liên kết đặt mật khẩu đã hết hạn. Hãy tạo liên kết mới, hoặc chuyển sang cửa hàng này và đặt lại mật khẩu trong phần Nhân viên.",
      username: "Tài khoản",
      expiresAt: "Hết hạn",
      setupLink: "Liên kết đặt mật khẩu",
      ids: "Nhà hàng / người dùng",
      copy: "Sao chép",
      copied: "Đã sao chép",
      regenerate: "Tạo lại liên kết",
      regenerating: "Đang tạo lại...",
    },
    deliveryChannel: { email: "Email", manual: "Chuyển tay" },
    deliveryStatus: {
      sent: "Đã gửi",
      pending: "Chờ xử lý",
      failed: "Gửi thất bại",
    ...
    reject: {
      ...
      description:
        "Vui lòng nêu lý do. Người nộp đơn sẽ nhìn thấy nội dung này.",
      reasonLabel: "Lý do từ chối",
      confirm: "Xác nhận từ chối",
    },
    regenerate: {
      title: "Tạo lại liên kết đặt mật khẩu?",
      description:
        "Liên kết cũ sẽ mất hiệu lực ngay. Nếu đã chuyển cho chủ cửa hàng, họ sẽ không dùng được nữa.",
      confirm: "Tạo lại",
    },
    errors: {
      ...
      reject: "Từ chối đơn thất bại. Vui lòng thử lại.",
  ...
  owner: {
    ...
    alerts: {
      inventory_depleted: {
        title: "{name} đã hết hàng",
        description: "{name} hiện còn 0 {unit} và cần được nhập thêm.",
      },
      inventory_low: {
        title: "{name} dưới mức tồn kho tối thiểu",
        description:
          "{name} hiện còn {currentStock} {unit}, thấp hơn mức tối thiểu {minStockLevel} {unit}.",
      },
      order_overdue: {
        title: "Đơn hàng {orderNumber} đã quá hạn",
        description:
  ...
  settings: {
    ...
    general: {
      ...
      restaurantAddressPlaceholder: "Ví dụ: 12 Đường Mẫu, Quận 1",
      city: "Thành phố",
      cityPlaceholder: "Ví dụ: Hồ Chí Minh",
      district: "Quận/Huyện",
      districtPlaceholder: "Ví dụ: Quận 1",
      districtRequired: "Nhập quận/huyện thực tế.",
      onboardingPlaceholderHint:
        "Đây là dữ liệu tạm khi kích hoạt. Hãy thay bằng địa chỉ thực tế.",
  ...
  leaveActions: {
    cancelReasonPrompt: "Nhập lý do huỷ",
  },
  payment: {
    recommended: "Đề xuất",
  ...
  billing: {
    ...
    meter: {
      orders_created: "Đơn đã tạo",
      api_requests: "Yêu cầu API",
      print_jobs: "Lệnh in",
      ai_requests: "Yêu cầu AI",
      storage_bytes: "Dung lượng lưu trữ (byte)",
    },
  },
};
