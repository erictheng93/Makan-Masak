...
const jaJP: Messages = {
  ...
  reviews: {
    title: "お客様レビュー",
    description: "注文と料理への評価を確認し、未返信のレビューに返信します。",
    summary: {
      heading: "レビュー概要",
      average: "平均評価",
      count: "レビュー {count} 件",
      unreplied: "未返信 {count} 件",
      allReplied: "すべて返信済み",
      distribution: "評価の内訳",
      starLabel: "星 {rating}",
    },
    ...
    card: {
      guest: "ゲスト",
      order: "注文 {orderNumber}",
      orderUnknown: "注文番号なし",
      dishRatings: "料理の評価",
      dishUnknown: "提供終了の商品",
      noContent: "コメントのない評価です。",
      replyHeading: "店舗からの返信",
      replyPlaceholder: "このレビューへの返信を入力…",
      replySubmit: "返信",
      replySending: "送信中…",
    },
    empty: {
      title: "お客様レビューはまだありません",
      hint: "注文完了後にお客様がレビューを投稿でき、ここに表示されます。",
      filteredTitle: "条件に一致するレビューがありません",
      filteredHint: "評価・返信状況・期間の条件を広げてみてください。",
    },
    pagination: {
      summary: "{page} / {totalPages} ページ · 全 {total} 件",
      prev: "前へ",
      next: "次へ",
    },
    errors: {
      noRestaurant: "先に店舗を選択してください。",
      loadFailed:
        "お客様レビューを読み込めませんでした。時間をおいて再試行してください。",
      forbidden: "この店舗のレビューを閲覧する権限がありません。",
      replyFailed:
        "返信を送信できませんでした。時間をおいて再試行してください。",
      replyRequired: "返信内容を入力してください。",
      notFound: "このレビューが見つかりません。再読み込みしてください。",
    },
    messages: {
      replied: "返信を送信しました。",
    },
  ...
  platformOnboarding: {
    ...
    badgeAriaLabel: "審査待ちの申請 {count} 件",
    filter: { all: "すべての状態" },
    status: {
      submitted: "審査待ち",
      provisioning: "準備中",
    ...
    plan: { trial: "トライアル" },
    handoff: {
      title: "{business}：オーナー開通情報",
      manualNote:
        "メールは送信されません。アカウントとパスワード設定リンクをオーナーへお渡しください。リンクは24時間有効で、一度使うと無効になります。",
      dismiss: "閉じる",
      delivery: "認証情報の配信：{channel} · {status}",
      unavailable:
        "利用できる設定リンクがありません。オーナーが既にパスワードを設定した可能性があります。ログインできない場合は、この店舗に切り替えて「スタッフ管理」からパスワードを再設定してください。",
      expired:
        "この設定リンクは期限切れです。再生成するか、この店舗に切り替えて「スタッフ管理」からパスワードを再設定してください。",
      username: "アカウント",
      expiresAt: "有効期限",
      setupLink: "設定リンク",
      ids: "店舗 / ユーザー",
      copy: "コピー",
      copied: "コピー済み",
      regenerate: "設定リンクを再生成",
      regenerating: "再生成中...",
    },
    deliveryChannel: { email: "メール", manual: "手渡し" },
    deliveryStatus: {
      sent: "送信済み",
      pending: "保留中",
      failed: "送信失敗",
    ...
    regenerate: {
      title: "設定リンクを再生成しますか？",
      description:
        "古いリンクは直ちに無効になります。既に渡している場合、オーナーは使用できなくなります。",
      confirm: "再生成する",
    },
    errors: {
  ...
  owner: {
    ...
    alerts: {
      inventory_depleted: {
        title: "{name} の在庫がありません",
        description: "{name} の在庫が 0 {unit} です。至急補充してください。",
      },
      inventory_low: {
        title: "{name} が最低在庫を下回っています",
        description:
          "{name} の在庫は {currentStock} {unit} で、最低在庫 {minStockLevel} {unit} を下回っています。",
      },
      order_overdue: {
        title: "注文 {orderNumber} が遅延しています",
        description:
  ...
  settings: {
    ...
    general: {
      ...
      restaurantAddressPlaceholder: "例：東京都千代田区サンプル通り 12",
      city: "市区町村",
      cityPlaceholder: "例：東京都",
      district: "地区",
      districtPlaceholder: "例：千代田区",
      districtRequired: "実際の地区を入力してください。",
      onboardingPlaceholderHint:
        "これは開通時の仮データです。実際の住所に変更してください。",
      businessHours: "営業時間",
      to: "〜",
      timezone: "タイムゾーン",
      timezones: {
  ...
  leaveActions: {
    cancelReasonPrompt: "取り消しの理由を入力してください",
  },
  payment: {
    recommended: "おすすめ",
